...
$(document).ready(function(){
  ...
  $(".seachform2").fadeIn(200);
    ...
    <div class="formtitle"><span>作业列表</span></div>
    ...
    <table class="tablelist">
      ...
      <s:iterator value="works" var="w" status="s">
        <tr>
        ...
        <td>${describe}</td>
        <td>已审核</td>
        <td><a href="listStudentWork.do?swid=${id}" class="tablelink">查看</a>     <a href="#" class="tablelink"> 删除</a></td>
        </tr> 
       </s:iterator>
