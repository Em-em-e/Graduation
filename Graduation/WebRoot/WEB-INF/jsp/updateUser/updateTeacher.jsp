...
<link href="style.css" rel="stylesheet" type="text/css" />
	...
	<SCRIPT type="text/javascript" src="js/updateTeacher.js"></SCRIPT>
</head>
...
<body>
    ...
    <ul class="forminfo">
    <li><label>姓 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</label>
   		 <input  type="text" class="dfinput" readonly="readonly" value="${tea.name }"/>
    </li>
    <li><label>用 &nbsp;户&nbsp; 名</label>
   		 <input  type="text" class="dfinput" readonly="readonly" value="${tea.username }"/>
    </li>
    <li><label>原始密码</label>
